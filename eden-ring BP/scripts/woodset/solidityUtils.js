...
const matchStates = (perm, match) => Object.entries(match).every(([key, value]) => String(perm.getState(key)) === String(value));
...
registerSupportGroup("lightning_rod", [
...
registerSupportGroup("down_face_support", [
...
registerSupportGroup("vertical_support", [
    "minecraft:oak_fence",
...
registerSupportGroup("non_support", [
    //Plants
    "minecraft:allium",
...
// GLAMMED BLOCKS
registerSupportGroup("nonSolidGlammedBlocks", [
    "glammed:glowshroom",
...
registerSupportGroup("glammed:stair", [
...
registerSupportGroup("glammed:slabs", [
    "glammed:slate_slab",
